...
export const tabsConfig = [
  ...
  { value: "skin-recovery", title: "Pele e Recuperação: A Relação Vital Entre Sono e Aparência", description: "A relação vital entre um bom sono e uma pele saudável.", href: "https://gamma.app/docs/pjbewllnbt0uyrh", image: "https://picsum.photos/seed/tab6/400/200", imageHint: "healthy skin" },
  { value: "sleep-strategy", title: "Busque a Melhor Estratégia para Pegar no Sono em Até 5–10 Minutos", description: "Estratégias para adormecer em 5 a 10 minutos.", href: "https://gamma.app/docs/aopjxwr6vsgr7mu", image: "https://picsum.photos/seed/tab7/400/200", imageHint: "calm lake" },
