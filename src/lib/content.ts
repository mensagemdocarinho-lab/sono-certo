...
export const tabsConfig = [
  { value: "anxiety-program", title: "Programa de 7 Dias para Aliviar a Ansiedade e Dormir Melhor", description: "Siga este programa passo a passo para acalmar a mente e treinar seu corpo para um sono mais profundo.", href: "https://gamma.app/docs/opkmpdbhgn0cepz", image: "https://i.imgur.com/AXnZk0b.png", imageHint: "calm yoga" },
  { value: "natural-teas", title: "Chás Naturais para um Sono Reparador", description: "Descubra os melhores chás para uma noite de sono reparadora.", href: "https://gamma.app/docs/6aytv0tnowbe57l", image: "https://i.imgur.com/UcijO4J.png", imageHint: "tea cup" },
  { value: "natural-remedies", title: "Remédios Naturais para o Sono: Tradições do Mundo", description: "Tradições do mundo para ajudar você a dormir melhor.", href: "https://gamma.app/docs/kt749veehwvpxc2", image: "https://i.imgur.com/zl8Ia4q.jpeg", imageHint: "natural herbs" },
  { value: "digital-curfew", title: "Curfew Digital e Café Consciente: Controle de Telas e Cafeína", description: "Controle o uso de telas e cafeína para proteger seu sono.", href: "https://gamma.app/docs/zplqd9vqi6r9h1z", image: "https://i.imgur.com/M9h50mq.jpeg", imageHint: "no smartphone" },
  { value: "ebook-practical-guide", title: "Adormecer em 10-20 Minutos: Guia Prático", description: "Um guia prático para adormecer mais rápido e ter um sono de qualidade.", href: "https://gamma.app/docs/aopjxwr6vsgr7mu", image: "https://i.imgur.com/O2xHs8b.jpeg", imageHint: "reading book" },
];
